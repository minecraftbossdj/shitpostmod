package com.awesoft.shitpostmod.Items.Draconic;
...
public class ModularTestChestpiece extends ArmorItem implements IModularArmor, IDEEquipment, EquippedModelItem {
    private final TechLevel techLevel;

    public ModularTestChestpiece(TechProperties props) {
    ...
    public boolean canEquip(ItemStack stack, EquipmentSlot armorType, Entity entity) {
        if (entity instanceof LivingEntity && !EquipmentManager.findItem(e -> e.getItem() instanceof ModularTestChestpiece, (LivingEntity) entity).isEmpty()) {
            return false;
        }
    ...
    public boolean canEquip(ItemStack stack, LivingEntity livingEntity, String slotID) {
        if (!slotID.equals("body") || !EquipmentManager.findItem(e -> e.getItem() instanceof ModularTestChestpiece, livingEntity).isEmpty()) {
            return false;
        }

        return !(livingEntity.getItemBySlot(EquipmentSlot.CHEST).getItem() instanceof ModularTestChestpiece);
    }
    ...
    public ModuleHostImpl createHost(ItemStack stack) {
        ModuleHostImpl host = new ModuleHostImpl(techLevel, ModuleCfg.chestpieceWidth(techLevel)*2, ModuleCfg.chestpieceHeight(techLevel)*2, "chestpiece", ModuleCfg.removeInvalidModules);
